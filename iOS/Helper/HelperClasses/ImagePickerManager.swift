...
class ImagePickerManager: NSObject, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func openCamera(){
        ...
        if(UIImagePickerController .isSourceTypeAvailable(.camera)){
            ...
            let alertWarning = UIAlertView(title:"Warning".localized, message: "You don't have camera".localized, delegate:nil, cancelButtonTitle:"OK".localized, otherButtonTitles:"")
            alertWarning.show()
        }
    }
    func openGallery(){
