...
extension UIView {
    ...
    func borderView() {
        ...
        border.borderColor = UIColor(red: 209/255, green: 209/255, blue: 209/255, alpha: 1).cgColor
    ...
    func underlined(hexa: String) {
//        let border = CALayer()
//        let width = CGFloat(1.5)
//        border.borderColor = UIColor.black.cgColor
//        let widthValue = hexa.widthOfString(usingFont: UIFont(name: ChooseFont.Light.rawValue, size: 15)!)
//        border.frame = CGRect(x: 0, y: self.frame.size.height - width, width: widthValue, height: self.frame.size.height)
//        border.borderWidth = width
//        self.layer.addSublayer(border)
//        self.layer.masksToBounds = true
    }
    ...
    func cornerRounded(rounded: Int, _ clipsBounds: Bool = false) {
        self.layer.cornerRadius = CGFloat(rounded)
